...
## ValueSet: Establecimientos Privados (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-establecimientos-privados-vs | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:EstablecimientosPrivadosVS |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-establecimientos-privados-vs",
  "version" : "0.1.1",
  "name" : "EstablecimientosPrivadosVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-establecimientos-privados-cs"
    }]
  }
}
