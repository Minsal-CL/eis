...
## ValueSet: Nivel de Discapacidad (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-NiveldeDiscapacidad-VS | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:NiveldeDiscapacidadVS |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-NiveldeDiscapacidad-VS",
  "version" : "0.1.1",
  "name" : "NiveldeDiscapacidadVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-NiveldeDiscapacidad-CS"
    }]
  }
}
