...
## ValueSet: Origen de Discapacidad (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-OrigendeDiscapacidad-VS | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:OrigendeDiscapacidadVS |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-OrigendeDiscapacidad-VS",
  "version" : "0.1.1",
  "name" : "OrigendeDiscapacidadVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-OrigendeDiscapacidad-CS"
    }]
  }
}
