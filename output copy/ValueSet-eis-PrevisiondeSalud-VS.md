...
## ValueSet: Previsión de Salud (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-PrevisiondeSalud-VS | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:PrevisiondeSaludVS |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-PrevisiondeSalud-VS",
  "version" : "0.1.1",
  "name" : "PrevisiondeSaludVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-PrevisiondeSalud-CS"
    }]
  }
}
