...
## ValueSet: Condición de la Actividad Laboral (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-CondiciondelaActividadLaboral-VS | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:CondiciondelaActividadLaboralVS |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-CondiciondelaActividadLaboral-VS",
  "version" : "0.1.1",
  "name" : "CondiciondelaActividadLaboralVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-CondiciondelaActividadLaboral-CS"
    }]
  }
}
