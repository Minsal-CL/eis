# Códigos para Comunas en Chile - Guía de Estandares de Información de Salud v0.1.1
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/StructureDefinition/eis-comunas | *Version*:0.1.1 |
| Draft as of 2026-04-13 | *Computable Name*:ComunasCl |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.cl.minsal.eis|current/StructureDefinition/eis-comunas)
