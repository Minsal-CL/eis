...
## ValueSet: Sexo Biológico (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/SexoBiologicoVS | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:SexoBiologicoVS |
...
```json
{
  ...
  "id" : "SexoBiologicoVS",
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/SexoBiologicoVS",
  "version" : "0.1.1",
  "name" : "SexoBiologicoVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-SexoBiologico-CS"
    }]
  }
}
