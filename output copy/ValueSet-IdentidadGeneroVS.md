...
## ValueSet: Identidad de Género (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/IdentidadGeneroVS | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:IdentidadGeneroVS |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/IdentidadGeneroVS",
  "version" : "0.1.1",
  "name" : "IdentidadGeneroVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-IdentidadGenero-CS"
    }]
  }
}
