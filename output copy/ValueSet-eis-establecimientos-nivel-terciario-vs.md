...
## ValueSet: Establecimientos Públicos de Nivel Terciario (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-establecimientos-nivel-terciario-vs | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:EstablecimientosNivelTerciarioVS |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-establecimientos-nivel-terciario-vs",
  "version" : "0.1.1",
  "name" : "EstablecimientosNivelTerciarioVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-establecimientos-nivel-terciario-cs"
    }]
  }
}
