...
## ValueSet: Religiones & Cultos (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-Religion-VS | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:ReligionVS |
...
```json
{
  ...
  "id" : "eis-Religion-VS",
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-Religion-VS",
  "version" : "0.1.1",
  "name" : "ReligionVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-Religion-CS"
    }]
  }
}
