...
## ValueSet: GES (Garantías Explícitas en Salud) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-GES-VS | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:GESVS |
...
```json
{
  ...
  "id" : "eis-GES-VS",
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-GES-VS",
  "version" : "0.1.1",
  "name" : "GESVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-GES-CS"
    }]
  }
}
