...
## ValueSet: Especialidades y Subespecialidades Médicas (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-EspecialidadesySubespecialidadesMedicas-VS | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:EspecialidadesySubespecialidadesMedicasVS |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-EspecialidadesySubespecialidadesMedicas-VS",
  "version" : "0.1.1",
  "name" : "EspecialidadesySubespecialidadesMedicasVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-EspecialidadesySubespecialidadesMedicas-CS"
    }]
  }
}
