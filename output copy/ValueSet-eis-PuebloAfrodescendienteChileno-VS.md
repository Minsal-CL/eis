...
## ValueSet: Pueblo Afrodescendiente Chileno (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-PuebloAfrodescendienteChileno-VS | *Version*:0.1.1 |
| Active as of 2026-03-01 | *Computable Name*:PuebloAfrodescendienteChilenoVS |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-PuebloAfrodescendienteChileno-VS",
  "version" : "0.1.1",
  "name" : "PuebloAfrodescendienteChilenoVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-PuebloAfrodescendienteChileno-CS"
    }]
  }
}
