Profile: DEISIdentificadorDigito
Parent: Identifier
Id: deis-identifier-digit
Title: "DEIS Identificador Paciente con digito"
...
* extension contains DigitoVerificador named digitoVerificador 0..1 MS
...
* type MS
* type from TipoIdentificadorVS (required)
