...
********************************************************/
CodeSystem: EspecialidadesOdontologicasCS
...
* #10 "Periodoncia"
* #11 "Rehabilitación Oral Removible"
* #12 "Salud Pública"
* #13 "Somato-Prótesis"
* #14 "Trastornos Temporomandibulares y Dolor Orofacial"
* #15 "Odontogeriatría"
* #16 "Rehabilitación Oral Fija"
...
ValueSet: EspecialidadesFarmaceuticasVS
Id: eis-especialidades-farmaceuticas-vs
Title: "Especialidades Farmacéuticas"
...
* codes from system EspecialidadesFarmaceuticasCS

/********************************************************
Especialidades y Subespecialidades Farmacéuticas o Químico Farmacéuticas
********************************************************/

CodeSystem: EspecialidadesBioquimicasCS
...
********************************************************/
CodeSystem: EspecialidadesEnfermeriaCS
...
ValueSet: EspecialidadesEnfermeriaVS
...
* codes from system EspecialidadesEnfermeriaCS
/********************************************************
...
* #1 "Baja Complejidad" "Establecimientos que otorgan prestaciones básicas de hospitalización y atención clínica, sin unidades de pacientes críticos ni pabellones quirúrgicos de mayor complejidad, orientados a la resolución de patologías de baja complejidad."
* #2 "Mediana Complejidad" "Establecimientos que, sin disponer de unidades de atención de pacientes críticos, cuentan con pabellones de intervención quirúrgica para la realización de cirugías generales y prestaciones clínicas que no requieren la participación de subespecialidades quirúrgicas complejas."
* #3 "Alta Complejidad" "Establecimientos que cuentan con unidades destinadas a la atención de pacientes críticos, tales como unidades de cuidados intensivos o intermedios, y que disponen de recursos humanos especializados, equipamiento tecnológico avanzado y capacidad para resolver patologías de alta complejidad clínica y quirúrgica."
